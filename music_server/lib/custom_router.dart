...
class CustomRouter {
  ...
  CustomRouter({Handler notFoundHandler = _defaultNotFound}) : _notFoundHandler = notFoundHandler;
  ...
  void remove(String route) => _routes.removeWhere((element) => element.route == route);
...
class RouterEntry {
  ...
  RouterEntry._(this.verb, this.route, this._handler, this._middleware, this._routePattern, this._params);
  ...
  factory RouterEntry(
    ...
    return RouterEntry._(verb, route, handler, middleware, routePattern, params);
  }
